...
def best_sentences(search_str="", minimum=0.5, limit=10, highest=True, sentances_path="../Data/sentences.tsv") -> list:
    search_terms = search_str.split(" ")
    with open(sentances_path, "r", encoding="utf-8") as file:
